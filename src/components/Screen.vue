  ...
  <section class="app-shot-one" id="screens">
    <div class="container-fluid">
      <div class="block-title text-center">
        ...
        <h3>Checkout Our Application Interface Look</h3>
      </div>
        ...
        >
          ...
          >
            <div
              ...
              style="width: 445px; margin-right: 30px"
            >
              <img
                src="/_next/static/images/app-shot-n-1-1-95ca6dcfa6a565ce6b4b662a345e5c2f.png"
                alt="Awesome Image"
              />
            </div>
            <div
            ...
            >
              <img
                src="/_next/static/images/app-shot-n-1-2-6d0fbb52f52e37a49f5dbddbfb4954eb.png"
                alt="Awesome Image"
              />
            </div>
            <div
            ...
            >
              <img
                src="/_next/static/images/app-shot-n-1-3-671c0c662d416431f3845c7d312167e7.png"
                alt="Awesome Image"
              />
            </div>
            <div
            ...
            >
              <img
                src="/_next/static/images/app-shot-n-1-4-3e6448c06bb68624a275f5e417cac1f4.png"
                alt="Awesome Image"
              />
            </div>
            <div
            ...
            >
              <img
                src="/_next/static/images/app-shot-n-1-5-260a010857402b29bcc86f74edc76a06.png"
                alt="Awesome Image"
              />
            </div>
            <div
    ...
    <div class="faq-one">
      ...
      <div class="container">
        <div class="block-title text-center">
          ...
          <h3>Want to Ask Something From Appton?</h3>
        </div>
        <div class="accrodion-grp faq-accrodion">
          <div class="accrodion">
    ...
    <div class="blog-one" id="blog">
      <div class="container">
        <div class="block-title text-center">
          <p>Latest News &amp; Articles</p>
          <h3>Checkout What’s Going on in Our Blog</h3>
        </div>
        <div class="row">
          <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="blog-one__single">
              <div class="blog-one__image">
                <img
                  src="/_next/static/images/blog-1-1-05a23026fc6ed76e412767090db407c2.jpg"
                  alt=""
                />
              </div>
              <div class="blog-one__content">
                <div class="blog-one__circle"></div>
                <div class="blog-one__content-inner">
                  ...
                  <h3>
                    <a href="/blog-post"
                      >Leverage agile frame works to provide a synopsis for</a
                    >
                  </h3>
                </div>
              </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="blog-one__single">
              <div class="blog-one__image">
                <img
                  src="/_next/static/images/blog-1-2-95a97e5d4eb4d62ac4a15be096216564.jpg"
                  alt=""
                />
              </div>
              <div class="blog-one__content">
          ...
          <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="blog-one__single">
              <div class="blog-one__image">
                <img
                  src="/_next/static/images/blog-1-3-bef24bfa4130b1c68dfcdab563158d3e.jpg"
                  alt=""
                />
              </div>
              <div class="blog-one__content">
